...
import { payoutProject, approveProject } from '../services/blockchain' // Import the approveProject function
...
const ProjectDetails = ({ project }) => {
  ...
  const handleApprove = async () => {
    try {
      ...
      setIsApproved(true); // Set isApproved to true once project is approved
    } catch (error) {
      console.error('Error while approving project:', error);
    }
  };
          ...
          <div className="flex-1 sm:py-0 py-4">
            ...
            <div>
              ...
              rounded-full shadow-md hover:bg-green-700"
                ...
                {/* Approve button */}
                {!isApproved && connectedAccount != project?.owner && project?.status === 0 && (
                  <button
                    type="button"
