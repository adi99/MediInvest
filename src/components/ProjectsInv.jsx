...
const Projects = ({ projects }) => {
  ...
  const getCollection = () => projects.slice(0, end).filter(project => project.raised >= project.cost)
  ...
  return (
    <div className="flex flex-col px-6 mb-7">
      ...
      {projects.length > end && collection.length < projects.length ? (
